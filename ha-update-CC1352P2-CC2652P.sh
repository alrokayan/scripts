...
#
# HOW TO:
# rm -rf scripts ; git clone https://github.com/alrokayan/scripts.git && chmod +x scripts/* && ./scripts/ha-update-CC1352P2-CC2652P.sh 192.168.0.2
# OR
...
if [ -z "$1" ] || [ "$1" = "-h" ] || [ "$1" = "--help" ]; then
    echo "Usage: $0 <Adaptor IP>"
    echo "EXAMPLE: $0 192.168.0.2"
    if [ "$1" = "-h" ] || [ "$1" = "--help" ]; then
        echo "This script will update the CC1352P2/CC2652P2 firmware"
        exit 0
    fi
    exit 1
fi
