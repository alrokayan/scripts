...
#
# HOW TO:
# rm -rf scripts ; git clone https://github.com/alrokayan/scripts.git && chmod +x scripts/* && ./scripts/post-install.sh
# OR
...
sed -i '/#   PasswordAuthentication yes/c\    PasswordAuthentication yes' /etc/ssh/ssh_config
