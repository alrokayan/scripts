...
#
# HOW TO:
# rm -rf scripts ; git clone https://github.com/alrokayan/scripts.git && chmod +x scripts/* && ./scripts/k8s-kubeadm-certs-update.sh 10.10.1.10 127.16.0.10 master master.example.com
# OR
