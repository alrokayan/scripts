...
#
# HOW TO:
# rm -r scripts && git clone https://github.com/alrokayan/scripts.git && cd scripts && chmod +x * && ./docker-run-codeserver.sh /docker-volumes/code-server PASSWORD example.com
# OR
